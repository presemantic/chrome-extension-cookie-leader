...
- `assets/render-screenshot.mjs` renders the required 1280x800 Web Store screenshot with fictional cookie data; its generated PNG is stored beside it together with the final `small.png` and `merquee.png` promotional tiles.
